...
export function HeroSection() {
  return (
    <div className="relative w-full min-h-screen overflow-hidden bg-linear-to-b from-zinc-950 via-zinc-900 to-black">
...
=======
        ...
        {/* Enhanced glow effect */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none">
          <div className="w-full h-full bg-zinc-800/20 rounded-full blur-3xl animate-pulse-glow" />
>>>>>>> 81d6f3c (Reuploaded fixed project)
        </div>
